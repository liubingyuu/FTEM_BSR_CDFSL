    ...
    for _, (x, y) in enumerate(novel_loader):
        ...
        for epoch in range(total_epoch):
            ...
            for j in range(0, support_size, batch_size):
                ...
                output_s = pretrained_model(z_batch_s)
                output_q = pretrained_model(z_batch_q)
                output_s = classifier(output_s)
                output_q = classifier(output_q)
        ...
        print('BSR+ENT: %f' % (correct_ori / count_this * 100))
        ...
        print('BSR+LP+ENT: %f' % (correct_lp / count_this * 100))
